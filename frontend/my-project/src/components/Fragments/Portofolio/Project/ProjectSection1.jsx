      ...
      <section className="mb-20 pt-48 w-full">
        <div className="lg:w-[89vw] lg:mx-14 md:w-[87vw]  md:mx-14 sm:w-[87vw] sm:mx-[2.6rem] w-[87vw] mx-6">
          ...
          <motion.p
            ...
            className="lg:w-[49rem] lg:text-[1.4rem] lg:ml-16 md:w-[80vw] md:text-[1.4rem] sm:w-[80vw] sm:text-[1.4rem] sm:ml-16 w-[85vw] text-[1.2rem] ml-2 bg-clip-text text-transparent bg-gradient-to-r from-[#ECE9E6]  to-[#FFFFFF]"
          >
