...
const UpdateFormSkill = (props) => {
  ...
  const handleUpdateSkill = async (event) => {
    ...
    try {
      await authService.fetchUpdateSkill(data.id, data);
      ...
      <div className="flex flex-col w-[30rem] h-[32rem] absolute left-[15%] top-[5%] items-center bg-white rounded-xl  overflow-hidden">
        <div className="overflow-y-auto overflow-x-hidden">
          ...
          <div className="mb-8 mt-4 ml-4">
            <h1 className="text-3xl font-bold font-serif">Update Skill</h1>
          </div>
...
export default UpdateFormSkill;
